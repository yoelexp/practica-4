 ...
 * @author Josue
 */
public class SeleccionJugadores extends javax.swing.JDialog {

    /**
     * Creates new form ListaJugadores
     */
    public SeleccionJugadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SeleccionJugadores dialog = new SeleccionJugadores(new javax.swing.JFrame(), true);
